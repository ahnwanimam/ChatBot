...
sk_embedding_data = torch.load('C:\Skuniv\workspace\ChatBot\model\sk_embedding_data_tensor.pt')
skChatData = pd.read_excel("C:\Skuniv\workspace\ChatBot\model\SKChatData.xlsx")
gen_embedding_data = torch.load('C:\Skuniv\workspace\ChatBot\model\gen_embedding_data_tensor.pt')
genChatData = pd.read_csv("C:\Skuniv\workspace\ChatBot\model\gen_ChatData.csv")
